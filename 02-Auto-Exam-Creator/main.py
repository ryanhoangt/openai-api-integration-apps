...
# Create an instance of the Teacher class which asks the user about the topic, number of possible
#  answers per question, and number of questions.
teacher = Teacher()
...
exam = Exam(student_view, answers, store_test=True,
            topic=teacher.test_creator.topic)
